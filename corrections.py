...
if __name__ == '__main__':
    ...
    plt.plot(AOA_corrected, CL_corrected, color = "green", label = "corrected data")
    plt.plot(AOA_List, CL_List, color = "orange", label = "original data")
    plt.xlabel('angle of attack [degrees]', fontweight='medium')
    plt.ylabel('Cl [-]', fontweight='medium')
    plt.legend(loc = 'lower right')
    plt.show()

    plt.plot(AOA_corrected, CD_corrected, color="green", label = "corrected data")
    plt.plot(AOA_List, CD_List, color="orange", label = "original data")
    plt.xlabel('angle of attack [degrees]', fontweight='medium')
    plt.ylabel('Cd [-]', fontweight='medium')
    plt.legend(loc = 'upper left')
    plt.show()

    plt.plot(AOA_corrected, CM_corrected, color="green", label = "corrected data")
    plt.plot(AOA_List, CM_List, color="orange", label = "original data")
    plt.xlabel('angle of attack [degrees]', fontweight='medium')
    plt.ylabel('Cm_c/4 [-]', fontweight='medium')
    plt.legend(loc = 'lower left')
    plt.show()

    plt.plot(CD_corrected, CL_corrected, color="green", label = "corrected data")
    plt.plot(CD_List, CL_List, color="orange", label = "original data")
    plt.xlabel('Cd [-]', fontweight='medium')
    plt.ylabel('Cl [-]', fontweight='medium')
    plt.legend(loc = 'lower right')
    plt.show()