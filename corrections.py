...
if __name__ == '__main__':
    ...
    plt.plot(AOA_corrected, CL_corrected, color = "red", label = "corrected data", linestyle="-", marker="o")
    plt.plot(AOA_List, CL_List, color = "blue", label = "original data", linestyle="-", marker="v")
    ...
    plt.plot(AOA_corrected, CD_corrected, color="red", label = "corrected data", linestyle="-", marker="o")
    plt.plot(AOA_List, CD_List, color="blue", label = "original data", linestyle="-", marker="v")
    plt.xlabel('Angle of Attack [degrees]', fontweight='medium')
    ...
    plt.plot(AOA_corrected, CM_corrected, color="red", label = "corrected data", linestyle="-", marker="o")
    plt.plot(AOA_List, CM_List, color="blue", label = "original data", linestyle="-", marker="v")
    plt.xlabel('Angle of Attack [degrees]', fontweight='medium')
    ...
    plt.plot(CD_corrected, CL_corrected, color="red", label = "corrected data", linestyle="-", marker="o")
    plt.plot(CD_List, CL_List, color="blue", label = "original data", linestyle="-", marker="v")
